...
import com.raman.snapchatclonex.auth.SignUpFragment;
...
public class ChatListFragment extends Fragment implements
    ...
    static final int RECEIVED_FRIEND_REQUESTS = 4;
    static final int RECEIVED_LIVE_FRIEND_REQUEST = 5;
    ...
    private TextView mFriendRequestProfileCount;
    ...
    public void setBottomSheet(BottomSheetBehavior mProfileBottomSheet, TextView mFriendRequestCardCount) {
        this.mProfileBottomSheet = mProfileBottomSheet;
        this.mFriendRequestProfileCount = mFriendRequestCardCount;
    }
    ...
    public void OnSendFriendRequestResponse(String requestSenderId, boolean accept) {
        ...
        FriendRequestBottomSheet.mInstance.dismiss();
    }
        ...
        public void handleMessage(@NonNull android.os.Message msg) {
            switch (msg.what) {
                case FRIEND_REQUEST_RESPONSE_RECEIVED:
                    ...
                    mFriendRequestProfileCount.setText(""+mFriendRequestMap.size());
                    //also update the bottom sheet yes
                    break;
