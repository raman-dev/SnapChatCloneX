...
import com.raman.snapchatclonex.auth.LoginActivity;
import com.raman.snapchatclonex.camera.CameraXFragment;


/*
*
* BUG SIGN IN -> CLICK OPEN PROFILE ->
* PRESS HOME -> CLICK SIGN OUT ->
* CLICK BACK ON LOGIN ACTIVITY ANOTHER LOGIN ACTIVITY BEHIND -> HAS TO DO WITH SINGLE TOP AND SINGLE TASK
*
* */
...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == CameraXFragment.CAMERA_CODE && permissions[0].equals(Manifest.permission.CAMERA)) {
    ...
    protected void onResume() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ...
            requestPermissions(new String[]{Manifest.permission.CAMERA}, CameraXFragment.CAMERA_CODE);
        } else {
            runApp();
        }
