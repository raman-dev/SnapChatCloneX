...
public class MainAppFragment extends Fragment implements
    ...
    private TextView mFriendRequestCardCount;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       FragmentStatePagerAdapter adapter = new MyStatePagerAdapter(getParentFragmentManager());
        ...
        view.findViewById(R.id.friendRequestCard).setOnClickListener(this);
        ...
        mFriendRequestCardCount = view.findViewById(R.id.friendRequestCount);
        return view;
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.signout_button:
                ...
                SnapchatAPI.SignOut();
                break;
            case R.id.friendRequestCard:
                Log.i(TAG,"show friend request card!");
    ...
    private class MyStatePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int i) {
            if (i == 0) {
                ...
                mChatListFragment.setBottomSheet(mProfileBottomSheet, mFriendRequestCardCount);
